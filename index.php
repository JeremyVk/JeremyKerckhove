...
<head>
    ...
    <meta name="description" content="Développeur Web Freelance basé à Puget sur Argens, non loin de Saint Raphaël/Frejus. Jérémy Kerckhove réalise vos sites vitrines sur mesure ainsi que vos E-commerces ">
...
<body>
    ...
    <header>
        ...
        <svg class="hamburger" id="hamburger" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <section class="section2">
        <div class="presentation" id="presentation">
            ...
            <p>Mon but est de vous satisfaire le plus possible en réalisant toutes vos idées, et de vous guider tout au
        ...
        <div class="prestations">
            <div class="item-prestation" id="item1">
                ...
                <p>Maquettage de votre site vitrine </p>
                <p>Site Web Responsive</p>
                <p>Référencement</p>
                <p>Sur mesure</p>
                <p>Nom de domaine + Hébergement</p>
            </div>
            ...
            <div class="me-contacter">
                ...
                <a href="#contact"><button class="btn-action"> Me contacter</button></a> 
            </div>
        </div>
    </section>
